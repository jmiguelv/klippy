...
- [x] **`feat/mobile-responsiveness`** — general mobile layout pass: composer, chat bubbles, retrieval steps, and source cards need responsive sizing and spacing adjustments below 640px
